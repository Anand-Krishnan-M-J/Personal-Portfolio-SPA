...
import { deleteProjectItem, editProjectItem, getProjects, projectStateType } from '../../store/projects/reducer';
...
const Dashboard = (props: any) => {
    ...
    const [tableData, setTableData] = useState<{ blog: BlogItem[], project: ProjectItem[], emails: emailDataItem[] }>({ blog: [], project: [], emails: [] })
    useEffect(() => {
            ...
            dispatch(
                editProjectItem({
                    data: {
                        ...
                        showinportfolio: !tableData.project.find((item: { id: number }) => item.id === id)?.showinportfolio
                    }
                })
            )
        }
            ...
            <Modal sx={{ display: "flex", justifyContent: "center" }} onBackdropClick={handleFormModalClose} open={formModalOpen}
                ...
                <TemplateForm closeModal={handleFormModalClose}
                    ...
                    initialFormData={
                        ...
                        (selectedTab === "project" &&
                            tableData.project.find((item: { id: number }) => item.id === editId)
                        ) ||
                        {
                            id: -1,
                            title: "",
