  ...
  return (
    ...
    >
      <Typography sx={{ margin: "1rem", fontSize: "2rem", fontWeight: "600" }}>
        {isFormDetailsEdit ? `Edit ${formtitle}` : `Create ${formtitle}`}
      </Typography>
      <TextField
      ...
      <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
        ...
        <Checkbox
          value={templateFormData.showinportfolio}
          onChange={(e) => {
            handleChange(
      ...
      <Button onClick={handleSave} sx={{ margin: "1rem" }} variant="contained">
        {isFormDetailsEdit ? "Edit" : "Add"}
      </Button>
      <Button
        onClick={closeModal}
        sx={{ margin: "1rem", color: "red", borderColor: "red" }}
        variant="outlined"
      >
        Cancel
      </Button>
