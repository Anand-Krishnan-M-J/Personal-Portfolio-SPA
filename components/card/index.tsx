...
export const Card = ({ title, date, description, techStack, image, slug, endpoint, isListVariant }: CardItemProps) => {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', boxShadow: isListVariant?'0 0 3px grey':'none' }}>
            {isListVariant &&
                <Typography
                    component="h2"
                ...
                <Grid item xs={12} md={6} justifyContent='flex-start'
                    ...
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
                        {!isListVariant &&
                            <Typography
                                component="h2"
                                sx={{ fontWeight: "600", fontSize: "large", marginRight: '1rem' }}>
                                {title}
                            </Typography>}
